...
import { db, COLLECTIONS, APP_ID } from '../firebase';
import { collection, onSnapshot, addDoc, updateDoc, doc, query, where, setDoc, deleteDoc } from 'firebase/firestore';
...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    if (!teacherId) return;
    const col = (name: string) => collection(db, APP_ID, 'data', `${name}_${storeId}`);
